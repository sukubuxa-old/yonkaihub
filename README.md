                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script Yonkai Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
setclipboard("Yonkai Hub Is The Best")
...
Tabs.Main:AddButton({
        Title = "Yonkai Hub Discord Server",
...
Fluent:Notify({
    Title = "Yonkai Hub",
    Content = "Thanks For Using Yonkai Hub",
    Duration = 8
})
